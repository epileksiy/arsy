...
import model from '../Pump.glb';
import model_ios from '../Pump.usdz';

export default function ModelObserver1 (){
    const modelRef = React.useRef();
    setTimeout(()=>{
        try{
           document.getElementById('model-viewer1').scale = '1.3 1.3 1.3'; 
        }catch{
            console.log('i tried')
        }
    },1000);
